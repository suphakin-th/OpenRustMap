...
impl Osm {
	...
	pub fn from_osm_pbf_file(mut pbf: osmpbfreader::OsmPbfReader<std::fs::File>) -> Osm {
		let mut osm_data = Osm::default();
        ...
        tracing::debug!("Start xxx : {:?}", osm_data);
		osm_data
	}
